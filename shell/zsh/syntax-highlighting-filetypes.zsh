...
ZSH_HIGHLIGHT_STYLES+=(
  default                       'fg=7'
  unknown-token                 'fg=1,strikethrough'
  reserved-word                 'fg=10,bold'
  alias                         'fg=2,bold'
  builtin                       'fg=107,bold'
  function                      'fg=2,bold'
  command                       'fg=107,bold'
  ...
  dollar-double-quoted-argument 'fg=114'
  back-double-quoted-argument   'fg=173,bold'
  assign                        'fg=240,bold'
)
